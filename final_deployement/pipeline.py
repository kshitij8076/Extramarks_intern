...
class QuestionSolvingPipeline:
    def __init__(self):
        ...
        self.model_configs = {
            ...
            "biology_chemistry": "google/medgemma-4b-it",  # Using available alternative
            "prover": "deepseek-ai/deepseek-math-7b-rl",  # Using available alternative
            "vision": "Qwen/Qwen2-VL-72B-Instruct",  # Using available alternative
            "general": "meta-llama/Llama-3.1-8B-Instruct"  # Using available alternative
        }
    ...
    def load_base_model(self):
        ...
        try:
            model_name = "microsoft/Phi-4"  # Using available alternative
    ...
    def classify_difficulty_and_subject(self, question: str) -> Tuple[int, str]:
        """Classify question difficulty (1-5) and subject using base model with proper JEE examples."""
...
"""
        ...
        try:
            ...
            return 3, "general"  # Default fallback
    ...
    def solve_with_base_model(self, question: str) -> str:
        ...
        Provide a clear, detailed explanation of your solution.
    ...
    def solve_with_specialized_model(self, question: str, model_type: str) -> str:
        ...
        model, tokenizer = self.load_specialized_model(model_type)
        ...
        elif model_type == "biology_chemistry":
            prompt = f"Answer this biology/chemistry question with detailed explanation:\n\n{question}\n\nAnswer:"
    ...
    def solve_vision_question(self, question: str, image_data: Optional[str] = None) -> str:
        ...
        # This is a placeholder for vision model integration
        # You would need to implement the actual QVQ-72B model integration here
    ...
    def solve_question(self, question_data: Dict) -> Dict:
        ...
        if difficulty <= 2:
            ...
            if subject in ["maths", "physics"]:
                ...
                logger.info(f"Solving Level {difficulty} {subject} question with biology/chemistry model")
                solution = self.solve_with_specialized_model(question, "biology_chemistry")
                model_used = "biology_chemistry"
...
if __name__ == "__main__":
    ...
    # Example questions
    # test_questions = [
    #     "What is 5 + 3?",  # Level 1, maths
    #     "Solve for x: 2x + 5 = 15",  # Level 2, maths
    #     "Find the derivative of f(x) = x³ + 2x² - 5x + 1",  # Level 3, maths
    #     "Explain the process of photosynthesis",  # Level 3, biology
    #     "Prove that √2 is irrational",  # Level 4, prover
    # ]
