...
try:
    ...
    try:
        ...
        st.warning("Llama4ForConditionalGeneration not available. Llama 4 Scout will be disabled.")
    ...
    try:
        ...
        st.warning("Qwen2VL or qwen_vl_utils not available. Qwen2VL will be disabled.")
...
class ModelManager:
    ...
    def inference_llama_vision(self, question, image_path=None, max_tokens=256, temperature=0.7):
        ...
        if not image_path:
            messages[0]["content"] = [{"type": "text", "text": question}]
    ...
    def inference_llama33(self, question, max_tokens=512, temperature=0.7):
...
def clean_math_response(response):
    """Clean and format mathematical response"""
